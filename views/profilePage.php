...
<div class="container-profile">
    ...
    if ($_SESSION['usertype'] == 1) {
        ...
        <div class="image-view">
            <img src="../image/Quick Tickets logo.png" alt="" srcset="">
        </div>
    ...
    <h3 style="padding: 10px; color: white;text-align: center">Showing Movies</h3>
    <div style="width: unset" class="theaterCard">
        ...
        <?php } else { ?>
            <h3 style="text-align: center ;padding: 25px;color: white">No Showing Movies</h3>
        <?php } ?>
        <?php } ?>
